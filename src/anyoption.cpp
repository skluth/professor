	...
	if( !valueStoreOK() )
        ...
        for( int i = 0 ; i < option_counter ; i++ ){
                if( strcmp( options[i], option ) == 0 ){
                        ...
                        strcpy( values[ optionindex[i] ], length, value );
			return true;
		}
        }
        return false;
	...
	if( !valueStoreOK() )
        ...
        for( int i = 0 ; i < option_counter ; i++ ){
                if( strcmp( options[i], option ) == 0 ){
                        ...
                        values[ optionindex[i] ] = (char*) malloc(length);
                        strcpy( values[ optionindex[i] ], length, TRUE_FLAG );
			return true;
		}
        }
        return false;
	...
	if( !valueStoreOK() )
        ...
        for( int i = 0 ; i < optchar_counter ; i++ ){
                if( optionchars[i] == option ){
                        ...
                        strcpy( values[ optcharindex[i] ], length, value );
			return true;
		}
        }
        return false;
	...
	if( !valueStoreOK() )
        ...
        for( int i = 0 ; i < optchar_counter ; i++ ){
                if( optionchars[i] == option ){
                        size_t length = (strlen(TRUE_FLAG)+1)*sizeof(char);
                        values[ optcharindex[i] ] = (char*) malloc(length);
			strcpy( values[ optcharindex[i] ] , length, TRUE_FLAG );
			return true;
		}
        }
        return false;
